...
namespace Engineer_Calculator
{
    ...
    /// </summary>
     public class LenthConverter
    {
        public decimal FromValue { get; set; }
        public string FromNameUnit { get; set; }
        public string ToNameUnit { get; set; }
        ...
        public string GetAnswer()
        {
            ...
            lenth.Add("Kilometre_Nautical_Mile", FromValue /1.852m);
            ...
            lenth.Add("Metre_Nautical_Mile", FromValue / 1852 );
            ...
            lenth.Add("Centimetre_Nautical_Mile", FromValue / 185200);
            ...
            lenth.Add("Millimetre_Nautical_Mile", FromValue /1852000);
            ...
            lenth.Add("Micrometre_Nautical_Mile",FromValue /1852000000);
            ...
            lenth.Add("Nanometre_Nautical_Mile",FromValue / 1852000000000);
           ...
           //Mile Conversion
            ...
            lenth.Add("Mile_Nautical_Mile", FromValue / 1.151m);
            ...
            lenth.Add("Yard_Nautical_Mile",FromValue / 2025);
            ...
            lenth.Add("Feet_Nautical_Mile",FromValue / 6076);
            ...
            lenth.Add("Inch_Nautical_Mile", FromValue / 72913);
            
            //Nautical Mile Conversion
            lenth.Add("Nautical_Mile_Kilometre", FromValue *1.852m);
            lenth.Add("Nautical_Mile_Metre", FromValue * 1852);
            lenth.Add("Nautical_Mile_Centimetre", FromValue * 185200);
            lenth.Add("Nautical_Mile_Millimetre", FromValue * 1852000);
            lenth.Add("Nautical_Mile_Micrometre", FromValue * 1852000000);
            lenth.Add("Nautical_Mile_Nanometre", FromValue * 1852000000000);
            lenth.Add("Nautical_Mile_Mile", FromValue * 1.151m);
            lenth.Add("Nautical_Mile_Yard", FromValue * 2025);
            lenth.Add("Nautical_Mile_Feet", FromValue * 6076);
            lenth.Add("Nautical_Mile_Inch", FromValue * 72193);
